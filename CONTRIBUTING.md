...
- It's fine to ask for help. But you should have checked out the [documentation](https://godoc.org/git.parallelcoin.io/dev/tview) first in any case.
...
- Your changes must not decrease the project's [Go Report](https://goreportcard.com/report/git.parallelcoin.io/dev/tview) rating.
